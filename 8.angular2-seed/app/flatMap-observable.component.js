System.register(["angular2/core", "rxjs/Rx"], function (exports_1, context_1) {
    ...
    var core_1, Rx_1, FlatMapObservableComponent;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            FlatMapObservableComponent = (function () {
                function FlatMapObservableComponent() {
                    var keyups = Rx_1.Observable.fromEvent($("#search"), "keyup")
                        ...
                        return Rx_1.Observable.fromPromise(promise); //then create an observable from the promise and return it
                    });
                    keyups.subscribe(function (data) { return console.log(data); });
                }
                return FlatMapObservableComponent;
            }());
            FlatMapObservableComponent = __decorate([
                core_1.Component({
                    selector: 'flatMap-observable',
                    template: "\n        <input id=\"search\" type=\"text\" class=\"form-control\" placeholder=\"Search Artists\">\n    "
                }),
                __metadata("design:paramtypes", [])
            ], FlatMapObservableComponent);
            exports_1("FlatMapObservableComponent", FlatMapObservableComponent);
        }
    };
});
//# sourceMappingURL=flatMap-observable.component.js.map