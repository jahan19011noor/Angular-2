...
System.register(["angular2/core", "./post.service", "angular2/http"], function (exports_1, context_1) {
    ...
    var core_1, post_service_1, http_1, LifeCycleHooksComponent;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {//Following are the life cycle hooks of a component
            //to use them we need to implement their interfaces into the component
            //each interface has a method that has to be added to the component
            LifeCycleHooksComponent = (function () {
                function LifeCycleHooksComponent(_postService) {
            ...
            exports_1("LifeCycleHooksComponent", LifeCycleHooksComponent);
        }
    };
});
//# sourceMappingURL=life-cycleHookes.component.js.map