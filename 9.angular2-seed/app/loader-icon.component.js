System.register(["angular2/core", "./post.service", "angular2/http"], function (exports_1, context_1) {
    ...
    var core_1, post_service_1, http_1, LoaderIconComponent;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            LoaderIconComponent = (function () {
                function LoaderIconComponent(_postService) {
                    this._postService = _postService;
                    this.isLoading = true;
                }
                LoaderIconComponent.prototype.ngOnInit = function () {
                    var _this = this;
...
//# sourceMappingURL=loader-icon.component.js.map