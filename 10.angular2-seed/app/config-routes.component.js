System.register(["angular2/core", "angular2/router", "./albums.component", "./contact.component"], function (exports_1, context_1) {
    ...
    var core_1, router_1, albums_component_1, contact_component_1, ConfigRoutesComponent;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            ConfigRoutesComponent = (function () {
                function ConfigRoutesComponent() {
                }
                return ConfigRoutesComponent;
            }());
            ConfigRoutesComponent = __decorate([
            ...
            ], ConfigRoutesComponent);
            exports_1("ConfigRoutesComponent", ConfigRoutesComponent);
        }
    };
});
//# sourceMappingURL=config-routes.component.js.map