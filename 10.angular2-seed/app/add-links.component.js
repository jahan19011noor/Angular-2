System.register(["angular2/core", "angular2/router", "./albums.component", "./contact.component"], function (exports_1, context_1) {
    ...
    var core_1, router_1, albums_component_1, contact_component_1, AddLinksComponent;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function () {
            AddLinksComponent = (function () {
                function AddLinksComponent() {
                }
                return AddLinksComponent;
            }());
            AddLinksComponent = __decorate([
            ...
            exports_1("AddLinksComponent", AddLinksComponent);
        }
    };
});
//# sourceMappingURL=add-links.component.js.map